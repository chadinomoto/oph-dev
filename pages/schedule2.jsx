import {
      ...
      slot: [
        {
          ...
          act: [
            {
              title: 'การแข่งขัน MWIT Square ครั้งที่ 15',
  ...
  export default function Schedule() {
    ...
    const toggleDescription = (index) => {
      // Toggle the visibility of the description for the clicked activity
                          ...
                          >
                            <div className='flex flex-col gap-2'>
                              ...
                              <button
                                ...
                                onClick={() => toggleDescription(idx)} // Toggle description on button click
                              >
                                <div className='text-xs' />
                                <span className='text-sm font-semibold'>
                                  {descriptionVisible[idx] ? 'HIDE' : 'SHOW'}
                                </span>
                              </button>
                            </div>
                            {a.desc && descriptionVisible[idx] && ( // Display description if visible
